...
function convertFahrToCelsius(fahrenheit) {
    ...
    if (!isNaN(celsius)) {
        ...
        console.log(fahrenheit, `is not a valid number but a/an ${Array.isArray(fahrenheit) ? 'array' : typeof fahrenheit}.`);
        return (fahrenheit, `is not a valid number but a/an ${Array.isArray(fahrenheit) ? 'array' : typeof fahrenheit}.`)
    }
}
...
function checkYuGiOh(n) {
    ...
    for(let i=1; i<=n; i++) {
        if(i%30 === 0) 
            resultArray.push("yu-gi-oh");
        else if(i%10 === 0) 
            resultArray.push("yu-oh");
        else if(i%15 === 0) 
            resultArray.push("gi-oh");
        else if(i%6 === 0) 
            resultArray.push("yu-gi");
        else if(i%5 === 0) 
            resultArray.push("oh");
        else if(i%3 === 0) 
            resultArray.push("gi");
